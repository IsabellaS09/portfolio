...
const Resume: FC = () => {
  return (
    <div id="resume" className="min-h-screen w-4/5 self-center mb-4">
      ...
      <div className="mt-4 mx-4">
        <div className="flex flex-col gap-8">
          <ResumeSection
            leftSide={
              // TODO: Once this is out of view make into a toolbar
              <SkillCategoryLegend />
            }
            rightSide={
              <>
                    ...
                    <div className="text-left mb-4">
                      <div className="flex flex-col gap-4">
                        <div className="text-justify">
                          ...
                          suite to set up incoming team for success. Redeveloped
                          main functionality and ideated new functionality to
                          encourage user interaction.
                        </div>
                        <div className="text-justify">
                          Led a team of beginner React developers on building a
                          website to verify the validity of images based on C2PA
                          SDK.
                        </div>
                        <div className="text-justify">
                          NEXT.js website linked to DatoCMS, using TailwindCSS.
                          UI updates managed through firestore and implemented
                          new stream viewing tech, AWS IVS. Broadcast state
                          management, broadcast info (chat, inventory, etc.) and
                          stream status.
                        </div>
                        <div className="text-justify">
                          Implemented and designed JSON-based multi-screen form
                          generator in jQuery, multiple different types of
                          components dependent on different backend callbacks.
                        </div>
                      </div>
                    </div>
                  }
                  ...
                  description={
                    <div className="text-left">
                      <div>
                        ...
                        <p>
                          Cross-office voting system with drag and drop card and
                          board UI (Angular); services to populate/update voting
                          members and email vote digests (C#)
                        </p>
                        <p>
              ...
              <div className="flex flex-col gap-4 items-start">
                ...
                <ProjectDisplay
                  project={{
                    ...
                    libraries: [Libraries.FramerMotion, Libraries.TailwindCSS],
                    frontend: [FrontEnd.React],
                    tooling: [Tooling.Vite],
                  }}
                />
                ...
                <ProjectDisplay
                  ...
                  description={
                    <p>
                      NextJS website for perusal of past “The Amazing Race” clue
                      locations, and clue discovery. Used Leaflet mapping for
                      display and traversal through locations, implemented RTree
                      for faster search.
                    </p>
                  }
                />
